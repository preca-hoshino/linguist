...
import type { ProviderEmbeddingRequestAdapter } from '../../interface';
import type { InternalEmbeddingRequest, EmbeddingInput, EmbeddingTaskType } from '../../../../types';
...
function supportsInstructions(model: string): boolean {
  ...
  return parseInt(version, 10) >= 251215;
}
