// src/model/http/providers/newapi/error-mapping.ts — New API 错误映射
//
// New API 使用 OpenAI 兼容错误格式：
...
export function mapNewApiError(httpStatus: number, body: string): ProviderErrorInfo {
