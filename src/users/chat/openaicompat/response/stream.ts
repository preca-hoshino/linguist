// src/users/chat/openaicompat/response/stream.ts — OpenAI 兼容流式响应适配器

import type { UserChatStreamResponseAdapter } from '../../interface';
import type { GatewayContext, InternalChatStreamChunk, ChatStreamDelta } from '../../../../types';
