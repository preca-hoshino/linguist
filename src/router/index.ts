...
import type { GatewayContext, RoutedGatewayContext, InternalChatRequest, InternalEmbeddingRequest } from '../types';
 ...
 */
export function inferRequiredCapabilities(ctx: GatewayContext): string[] {
  if (!ctx.request) {
    return [];
  }
